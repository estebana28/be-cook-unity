  ...
  */
  ...
  export interface PokemonDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
    **/
    createManyAndReturn<T extends PokemonCreateManyAndReturnArgs<ExtArgs>>(
      args?: SelectSubset<T, PokemonCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$PokemonPayload<ExtArgs>, T, 'createManyAndReturn'>>
  ...
  interface PokemonFieldRefs {
    ...
    readonly type: FieldRef<"Pokemon", 'Type'>
  ...
  export type PokemonWhereInput = {
    ...
    type?: EnumTypeFilter<"Pokemon"> | $Enums.Type
  ...
  export type PokemonScalarWhereWithAggregatesInput = {
    ...
    type?: EnumTypeWithAggregatesFilter<"Pokemon"> | $Enums.Type
